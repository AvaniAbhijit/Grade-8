...
#Task1: Modify the style variables to design it with your favorite colors, padding, font_size, button size, etc
#Task1: This can be done for button style, title style, secret word style etc.
#Task 2: Search internet and find how to add background color in final game.
#Task 3: Try to add colors in the button also
...
class Word(toga.App):
    ...
    title_style = Pack(padding=(0, 5), font_size=15, text_align="center", font_weight="bold")
    secret_word_style = Pack(padding=(0, 5), font_size=25, text_align="center", font_weight="bold")
