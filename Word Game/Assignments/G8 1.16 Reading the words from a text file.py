...
#Task1: Create a new word file name "all_games" and save in the .txt format.
#Task1: Put as many games name in that file.
#Task2: Read this file name in the file_path variable instead of the english_words file.
