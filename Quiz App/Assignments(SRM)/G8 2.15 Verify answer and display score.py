# task 1: Run and Notice the score Label coming up due to line 112 and 113
# task 2: Print the value of selected_index in line 157 and observe the value 
# task 3: Modify line 155 to assign the third value of the output to selected_index
# task 4: Observe line 161 - how the check is happening for the correct answer
...
class LoginApp(toga.App):
    ...
    def display_selected_option(self, widget): #function to identify the selected option
        ...
        # Display updated score using score_label
        
            
        self.main_window.content.add(self.box2)

    def check_answer(self, widget):
        # Process the answer (you can add your validation logic here)
        # Get the index of the selected option
        selected_index = widget.value.split()  # example - ['o','p','1']
        # print the selected index. Modify the above line to fetch only the third element
        print()
        
        #check if the index is same as the value of the key 'ans'
        # if so increment the score and display it.
        if int(selected_index) == self.ques[self.current_index][1]['ans']:
            self.score += 1
            # display it using self.score_label
