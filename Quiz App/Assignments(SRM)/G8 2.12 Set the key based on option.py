# task1: In firebase,create for Computer science subject-> the subject key, question, 4 options and 1 answer.
# CS
...
class LoginApp(toga.App):
    ...
    def display_selected_option(self, widget): #function to identify the selected option
        ...
        if selected_option == 'Computer Science':
            ques_str = 'CS'
        #Complete the if condition for other subjects too
        #elif :
